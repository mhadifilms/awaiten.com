...
const Podcast = () => {
  ...
  useEffect(() => {
    updateSEOTags({
      ...
      description: 'Reading and writing the stories of the Muslim West. Celebrating entrepreneurs, chefs, doctors, animators, converts, and educators. Every failure is a lesson. Every story matters.',
      image: '/images/branding/PodcastBG.png',
