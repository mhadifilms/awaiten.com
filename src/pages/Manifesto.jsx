...
const Manifesto = () => {
  useEffect(() => {
    updateSEOTags({
      title: 'The Next Hollywood is Unscripted: Our Manifesto',
      description: 'In a world where every skill can be mastered by anyone, and the value of all skills goes to zero, those who stand out will be the best storytellers. Not stories that have been scripted, rather authentic stories—ones that are lived, captured, and shared with the world.',
      image: '/images/branding/embed.png',
      url: `${window.location.origin}/manifesto`,
      type: 'article'
    });
